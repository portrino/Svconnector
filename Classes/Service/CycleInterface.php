 ...
 *  Copyright notice
 *
 *  (c) 2015 André Wuttig (wuttig@portrino.de)
 *  All rights reserved
 *
...
/**
 * Interface Tx_Svconnector_Service_CycleInterface
 */
interface Tx_Svconnector_Service_CycleInterface {

	/**
	 * Has service a cycle behaviour
	 *
	 * @param array $parameters
	 * @return boolean TRUE if the a cycle behaviour is configured within TCA otherwise FALSE
	 */
	 ...
	 *
	 * @param array $parameters
	 * @return float|boolean Progress of the service as a two decimal precision float. f.e. 44.87 or FALSE if no rows_per_cycle are defined for the given table-index
	 */
